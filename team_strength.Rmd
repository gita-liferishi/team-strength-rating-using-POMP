...
mod<-lm(elo ~ `Last 5 Games BPM` + Home, data = bpm)
...
nba_pomp |>
  simulate(
    params=c(beta1=1.644043,sigma=1,home_court_avd=85.28318,alpha=0.6171001),
    nsim=20,format="data.frame",include.data=TRUE
  ) -> sims
...
nba_pomp2 |>
  simulate(
    params=c(beta1=1.251947,beta2=2.474494,sigma=1,home_court_avd=74.55269,alpha=0.8598805),
    nsim=20,format="data.frame",include.data=TRUE
  ) -> sims2
