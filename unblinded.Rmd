...
We define a linear regression model to serve as a baseline for understanding how Elo ratings relate to team performance indicators, independent of any latent process. The model is specified as:
...
bpm %>% select(time,Win,Home,`Last 5 Games BPM`,opp_elo,elo, home_attendance) -> red_bpm_att
